...
def main():
    ...
    shell.singleCall('/model')
    shell.singleCall('/help')
    # shell.singleCall('/model gpt4')
    # shell.singleCall('/stream')
    results = shell.backend.ask('hi', title=None, model_customizations={})
    results2 = shell.backend.ask('how are your', title=None, model_customizations={})
    results3 = shell.backend.ask('1+1=?', title=None, model_customizations={})
    shell.cleanup()
